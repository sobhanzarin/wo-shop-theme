...
<div>
  <div class="auth-page-holder row background-auth align-item-center justify-content-center">
      <div class="wrrap-auth-page d-flex flex-column justify-content-center col-12 col-md-4">
        <div class="text-center mb-4">
            ...
            <span class="title-form-login d-block mt-3">
            به وب سایت سیماگر شاپ خوش آمدید
          </span>
        </div>
