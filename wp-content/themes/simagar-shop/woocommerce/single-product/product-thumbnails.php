	...
	<div class="simagar-product-thumbs">
		<div class="simagar-product-meta">
			<ul class="d-flex d-md-block gap-3">
				...
				<li data-bs-toggle="tooltip" data-bs-title="مقایسه" data-bs-placement="right">
					<button href="javascript:void(0);" class="woosc-btn woosc-btn-<?php echo get_the_ID(); ?> woosc-btn-has-icon woosc-btn-icon-only" data-id="<?php echo get_the_ID(); ?>">
					<span class="woosc-btn-icon"></span></button>
				</li>
			</ul>
		</div>
