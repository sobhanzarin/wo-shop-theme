...
if( class_exists( 'CSF' ) ) {
  ...
  CSF::createSection( $prefix, array(
    ...
    'default' => '#008ECC',
    'output' => array(
      'color' => '.title_category, span.product_meta_item, .icon-header, .phone-header, .single-post-meta .item-post-meta i, .btn-search-post i, .simagar-profile-badges .badges-item i, .btn-product-search-result a, .simagar-offer-slider .title-holder i',
